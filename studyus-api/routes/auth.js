...
router.get("/me", cors(),  security.requireAuthenticatedUser, async (req,res,next) => {
    try
    {
...
router.get("/users/:userId", cors(), security.requireAuthenticatedUser, async (req,res,next) => {
    try
    {
